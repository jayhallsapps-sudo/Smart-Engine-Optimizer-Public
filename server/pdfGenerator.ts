...
// generateMonthlyPdf removed in Phase 3g — the puppeteer-based
// /api/reports/monthly/preview-pdf route renders the React preview directly,
// so this pdfkit variant (which never matched the on-screen design) has
