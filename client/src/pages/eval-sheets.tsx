...
const RAW_METRICS = [
  ...
  { key: "aiVisibilityScore",    label: "AI Visibility Score",source: "semrush",    type: "number", width: 110, refreshable: true,  tooltip: "SEMrush AI Toolkit — auto-fetched via domain_organic_ai report. Refresh to update." },
  { key: "aiMentions",           label: "Mentioned Responses",source: "semrush",    type: "number", width: 120, refreshable: true,  tooltip: "SEMrush AI Toolkit — AI Overview mention count. Refresh to update." },
  { key: "citedSources",         label: "Cited Sources",      source: "semrush",    type: "number", width: 105, refreshable: true,  tooltip: "SEMrush AI Toolkit — cited sources count from AI Overviews. Refresh to update." },
